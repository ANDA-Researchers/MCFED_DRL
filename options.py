...
def parse_args():
    ...
    # Simulation settings
    # Scenario settings
    parser.add_argument("--length", type=int, default=1000 * 2)
    parser.add_argument("--num_rsu", type=int, default=2)
    parser.add_argument("--num_vehicle", type=int, default=10)
    ...
    parser.add_argument("--cloud_rate", type=float, default=30e6)
    parser.add_argument("--fiber_rate", type=float, default=50e6)
